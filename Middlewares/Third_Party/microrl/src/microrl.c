...
void microrl_set_complete_callback (microrl_t * pThis, int (*get_completion)(const char* const, char const **))
{
...
void microrl_set_execute_callback (microrl_t * pThis, int (*execute)(const char* const))
{
