...
//   If complete token found, it must contain only one token to be completed
//   Empty string if completion is not found, and multiple string if there are some token
